            ...
            in
                {
                    ...
                    # 
                    # };
                    packages."x86_64-linux"   = pkgs.python;
                    packages."aarch64-linux"  = pkgs.python;
                    packages."i686-linux"     = pkgs.python;
                    packages."x86_64-darwin"  = pkgs.python;
                    packages."aarch64-darwin" = pkgs.python;
                }
        ;
    }