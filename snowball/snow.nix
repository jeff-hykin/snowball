            ...
            in
                {
                    ...
                    # 
                    # };
                    packages."x86_64-linux"   = pkgs.python38Packages.python;
                    packages."aarch64-linux"  = pkgs.python38Packages.python;
                    packages."i686-linux"     = pkgs.python38Packages.python;
                    packages."x86_64-darwin"  = pkgs.python38Packages.python;
                    packages."aarch64-darwin" = pkgs.python38Packages.python;
                }
        ;
    }